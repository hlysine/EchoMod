...
public class SelectCardsAction extends AbstractGameAction {
     ...
     * @param amount        - maximum number of cards allowed for selecting
    ...
    public void update() {
        if (this.duration == this.startDuration) {
            ...
            if (anyNumber) {
                AbstractDungeon.gridSelectScreen.open(selectGroup, amount, true, text);
            } else {
                AbstractDungeon.gridSelectScreen.open(selectGroup, amount, text, false, false, false, false);
            }
            tickDuration();
        }
