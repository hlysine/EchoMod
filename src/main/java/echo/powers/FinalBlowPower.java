...
public class FinalBlowPower extends AbstractPower implements CloneablePowerInterface, OnMonsterDeathSubscriber {

    public static final String POWER_ID = EchoMod.makeID(FinalBlowPower.class.getSimpleName());
    ...
    public void onMonsterDeath(AbstractMonster monster) {
        addToBot(new ApplyPowerAction(owner, owner, new UltimateChargePower(owner, amount)));
        flash();
    }
    ...
    public AbstractPower makeCopy() {
        return new FinalBlowPower(owner, amount);
    }
}
