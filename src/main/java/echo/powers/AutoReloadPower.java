...
public class AutoReloadPower extends AbstractPower implements CloneablePowerInterface {

    public static final String POWER_ID = EchoMod.makeID(AutoReloadPower.class.getSimpleName());
    ...
    public AbstractPower makeCopy() {
        return new AutoReloadPower(owner, amount);
    }
}
